...
export const filteredProducts = selector({
  ...
  get: ({ get }) => {
    ...
    const searchText: any = get(searchtextState);
    const filteredItem = get(productFilteredState);
    let filteredProducts = [];
    filteredProducts = products
      .filter((product) => product.name.toLowerCase().includes(searchText))
      .filter((product) =>
        filteredItem == "" ? true : product.type == filteredItem
      );
...
export const productFilteredState = atom({
  key: "productsFilteredState",
  default: "",
});

export const filteredItemCountState = selector({
  key: "filteredItemCountState",
  get: ({ get }) => {
    const allCount = get(filteredProducts);
